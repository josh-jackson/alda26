...
Combined: $${Y}_{ti} = \gamma_{00} + \gamma_{01}G_{i}+  \gamma_{10} (Time_{ti}) + \gamma_{11}(G_{i}*Time_{ti}) + $$ 
...
$${affect}_{ti} = \beta_{0i} + \beta_{1i}Exercise_{i} +  \beta_{2i}(Stress_{ti}-\overline{Stress_{i}}) + \varepsilon_{ti}$$
Can you interpret each of these $\gamma_{02}$, $\gamma_{12}$ , $\gamma_{22}$ terms at L2? 
...
$${\beta}_{1i} = \gamma_{10} + \gamma_{11}\overline{Stress_{i}} + \gamma_{12}Age_i +  U_{1i}$$
$${\beta}_{2i} = \gamma_{20} + \gamma_{22}Age_i + U_{2i}$$
...
- What does "\gamma_{01}" test in this case? 
